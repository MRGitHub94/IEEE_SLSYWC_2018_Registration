     ...
     if($result){
		...
		if ($email == "")
			...
			if ($sql->num_rows > 0) {
				...
				$link->query("INSERT INTO delegates (filepath,filename,firstname,lastname,gender,nic,university,otheruni,faculty,email,phone,food,tshirt,os,membership,ieeeID,ieeeTime,ieeeExperience,slsywcParticipation,feedback,isEmailConfirmed,token)
					VALUES ('$fileTarget','$fileName','$firstname','$lastname','$gender','$nic','$university','$otheruni','$faculty','$email','$phone','$food','$tshirt','$os','$membership','$ieeeID','$ieeeTime','$ieeeExperience','$slsywcParticipation','$feedback', '0', '$token');
				");
...
Technology and Medicine (SAITM)">
    ...
    <label for="ieeeID"><font color="#00378B">IEEE Membership ID</font></label> <small><font color="#9D9D9D">(*required)</font></small>
		<input type="text" id="" name="ieeeID" class="form-control" placeholder="ex: 94152027" maxlength="8" required />
							...
							<br>
												<div class="form-group">
													<label for="ieeeID"><font color="#00378B">Your IEEE Category</font></label> <small><font color="#9D9D9D">(*optional)</font></small><br>
		                                        <div class="col-sm-4">
		                               ...
		                               <label><font color="#00378B">What are your IEEE Experiences?</font></label> <small><font color="#9D9D9D">(*required)</font></small>
		                                ...
		                                <div class="row">
										  ...
										  <div class="col-sm-8 col-sm-offset-2">
												<div class="form-group">
		                                            <label>Have you ever participated IEEE SLSYW Congress?</label> <small><font color="#9D9D9D">(*required)</font></small>
							  ...
							  <br> <br>
		                                    <div class="col-sm-8 col-sm-offset-2">
													<label for="slsywcYears"><font color="#00378B">In which years were you participated? </font></label> <small><font color="#9D9D9D">(*optional)</font></small><br>
											...
											<div class="col-sm-8 col-sm-offset-2">
											  <div class="checkbox">
													 ...
													 <label> <strong>By submitting my information, I agree to the <a href="../terms_and_conditions" target="_blank">terms & conditions</a> of IEEE SLSYWC.</strong></label>
