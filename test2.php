     ...
     if($result){
		...
		if ($email == "")
			...
			if ($sql->num_rows > 0) {
				...
				$link->query("INSERT INTO delegates (filepath,filename,firstname,lastname,gender,nic,university,otheruni,faculty,email,phone,food,tshirt,os,membership,ieeeID,graduation,track,ieeeTime,ieeeExperience,slsywcParticipation,feedback,isEmailConfirmed,token)
					VALUES ('$fileTarget','$fileName','$firstname','$lastname','$gender','$nic','$university','$otheruni','$faculty','$email','$phone','$food','$tshirt','$os','$membership','$ieeeID','$graduation','$track','$ieeeTime','$ieeeExperience','$slsywcParticipation','$feedback', '0', '$token');
				");
