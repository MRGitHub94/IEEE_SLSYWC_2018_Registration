<?php
	...
	if (isset($_POST['submit'])) {
		...
		if($fileExistsFlag == 0){
	        ...
	        $graduation = mysqli_real_escape_string($link, $_POST["graduation"]);
     ...
     if($result){
		...
		if ($email == "")
			...
			if ($sql->num_rows > 0) {
				...
				$link->query("INSERT INTO delegates (filepath,filename,firstname,lastname,gender,nic,university,otheruni,faculty,email,phone,food,tshirt,os,membership,ieeeID,graduation,track,ieeeTime,ieeeExperience,slsywcParticipation,slsywcYears,feedback,isEmailConfirmed,token)
					VALUES ('$fileTarget','$fileName','$firstname','$lastname','$gender','$nic','$university','$otheruni','$faculty','$email','$phone','$food','$tshirt','$os','$membership','$ieeeID','$graduation','$track','$ieeeTime','$ieeeExperience','$slsywcParticipation','$b','$feedback', '0', '$token');
				");
                   ...
                   <table width='100%' cellspacing='0' cellpadding='0' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;'> 
                     ...
                     <tr style='border-collapse:collapse;'> 
                      <td align='center' style='Margin:0;padding-left:10px;padding-right:10px;padding-bottom:10px;padding-top:10px;'> <span class='es-button-border' style='border-style:solid;border-color:transparent;background:#F11E32;border-width:0px;display:inline-block;border-radius:5px;width:auto;'> 
						...
						<a href=' https://sywc.ieee.lk/test_reg/verify?email=$email&token=$token'> <img class='adapt-img' src='https://sywc.ieee.lk/images/verifynow.png' alt='' style='display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;' width='200'></a> </span> </td> 
                     </tr> 
                   </table> </td> 
                 </tr> 
               </table> </td> 
...
<body>
	...
	<!--	<a href="https:?//sywc.ieee.lk" class="made-with-pk">
	    ...
	    <a href="http://sywc.ieee.lk">
		                            	...
		                            	<div class="row">
											...
											<div class="col-sm-4 col-sm-offset-1">
												<div class="picture-container">
													...
													<small>(Make sure to upload 4x4, < 1MB clear photo of you.)</small>
												</div>
											</div>
											<div class="col-sm-6">
					...
					<div class="form-group">
                <label for="nic"> NIC Number:</label> <small><font color="#9D9D9D">(*required)</font></small>
                    <input class="form-control" type="text" name="nic" id = "nicNumber" required onkeyup = "validateNIC();" maxlength=12 placeholder="ex: 971394702V or 199713947020 " />  
                    
						  <small id="valNic"></small>
                        ...
                        <input type="text" class="nic-validate form-control" placeholder="Enter Your NIC No" required>
...
Technology and Medicine (SAITM)">
			...
			<option value="Aquinas College of Higher Studies">	
												...
												<div class="form-group">
													<label>Faculty / School </label> <small><font color="#9D9D9D">(*optional)</font></small>
...
<!-- Links --><small>
								...
								<div class="form-group">
                <label for="ieee"> IEEE Membership ID:</label> <small><font color="#9D9D9D">(*required)</font></small>
                    <input class="form-control" type="text" name="ieeeID" id="ieeeNumber" required onkeyup = "validateIEEE();" autofocus placeholder="ex: 94152027" maxlength="8" />  
                    
						  <small id="valieee"></small>
                        
            </div>
						<div class="form-group">
                <label> If you have already graduated, when did you graduate?</label> <small><font color="#9D9D9D">(*optional)</font></small>
                    <input class="form-control" type="date" name="graduation" id=""  placeholder="" />  
		                                    ...
		                                    <div class="col-sm-8 col-sm-offset-2">
		                                        ...
		                                        <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2017">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p>2017</p>
		                                                </div>
		                                        ...
		                                        <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2016">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p>2016</p>
		                                                </div>
		                                        ...
		                                        <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2015">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p><b>2015</b></p>
		                                                </div>
												 ...
												 <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2014">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p><b>2014</b></p>
		                                                </div>
												 ...
												 <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2013">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p><b>2013</b></p>
		                                                </div>
												 ...
												 <div class="col-sm-4">
		                                            <div class="choice" data-toggle="wizard-checkbox">
		                                                <input type="checkbox" name="slsywcYears[]" value="2012">
		                                                <div class="card card-checkboxes card-hover-effect">
		                                                    <i class="ti-pin"></i>
															<p><b>2012</b></p>
		                                                </div>
...
You can’t change the selected t-shirt size on the event day.</li>
	...
	<script src="assets/js/pc-system.js" async defer></script>
